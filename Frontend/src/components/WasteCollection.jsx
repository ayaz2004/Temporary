      ...
      >
        ...
        <div className="grid md:grid-cols-4 gap-6">
          <motion.div
            ...
            className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-green-500/20 shadow-xl hover:shadow-green-500/10"
          >
            <h3 className="text-gray-400 mb-2 font-medium">
              Total Collections
            </h3>
          ...
          <motion.div
            whileHover={{ scale: 1.02 }}
            transition={{ type: "spring", stiffness: 300 }}
            className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-yellow-500/20 shadow-xl hover:shadow-yellow-500/10"
          >
          ...
          <motion.div
            ...
            className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-green-500/20 shadow-xl hover:shadow-green-500/10"
          >
            <h3 className="text-gray-400 mb-2 font-medium">Collected</h3>
          ...
          <motion.div
            whileHover={{ scale: 1.02 }}
            transition={{ type: "spring", stiffness: 300 }}
            className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-teal-500/20 shadow-xl hover:shadow-teal-500/10"
          >
            <h3 className="text-gray-400 mb-2 font-medium">Total Revenue</h3>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-green-500/20">
          <div className="overflow-x-auto">
            <Table className="w-full">
              <Table.Head>
                <Table.HeadCell className="bg-gray-900/50 text-green-800 font-semibold border-b border-green-500/20">
                  Date
                </Table.HeadCell>
                <Table.HeadCell className="bg-gray-900/50 text-green-800 font-semibold border-b border-green-500/20">
                  Type
              ...
              <Table.Body className="divide-y divide-green-500/10">
                {filteredCollections.map((collection) => (
                  ...
                  >
                    <Table.Cell className="whitespace-nowrap font-medium text-green-500 px-6 py-4">
                      {new Date(collection.date).toLocaleDateString()}
                    </Table.Cell>
                    <Table.Cell className="text-green-500 px-6 py-4">
                      {collection.type}
                    </Table.Cell>
                    <Table.Cell className="text-green-500 px-6 py-4">
                      {collection.quantity}
